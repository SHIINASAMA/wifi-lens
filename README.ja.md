...
| 📈 **イベントタイムライン** | 接続イベント履歴——ローミング、チャネル変更、切断、信号低下 | Pro のみ |
| 📊 **統計** | ローカルのタイムライン履歴を期間選択・比較付きで分析 | Pro のみ |
| 💡 **インサイト** | タイムライン履歴から説明可能な発見を取得 | Pro のみ |
...
| 🔄 **自動アップデート** | GitHub 版は Sparkle アップデート、Pro は Mac App Store アップデート | OSS & Pro |
| 📤 **エクスポート** | バンドごとのチャートを PNG 画像または CSV データとして保存 | OSS & Pro |
| 🌍 **ローカライズ** | 英語、ドイツ語、スペイン語、日本語、簡体字中国語 | OSS & Pro |

**Pro のみ**と記載された機能を除き、すべての機能がオープンソース版に含まれます。Pro はオープンソース版の全機能に加え、録画・メニューバー・イベントタイムライン・統計・インサイトツールを提供します。
